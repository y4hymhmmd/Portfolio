...
/*==================== TYPED ====================*/
const textList = ["Yahya", "Student", "Dreamer", "Programmer"]; // Daftar teks yang akan diubah-ubah
...
function typeNextCharacter() {
  ...
  typingText.textContent = currentText.substring(0, currentCharacterIndex);
  currentCharacterIndex++;

  if (currentCharacterIndex <= currentText.length) {
    setTimeout(typeNextCharacter, typingSpeed);
  } else {
    // Teks saat ini telah selesai diketikkan, pindah ke teks berikutnya
...
function eraseText() {
  ...
  if (currentCharacterIndex >= 0) {
    ...
    // Penghapusan selesai, lanjut ke teks berikutnya
    currentTextIndex = (currentTextIndex + 1) % textList.length;
    setTimeout(typeNextCharacter, 500); // Tunggu 0.5 detik sebelum mengetikkan teks baru
  }
}
